        ...
        let texture_hdr = renderer
            .compile_custom_texture_shader(
                ...
                &[
                    ...
                    UniformName::new("niri_max_nit_scale", UniformType::_1f),
                    UniformName::new("niri_sdr_lum_scale", UniformType::_1f),
                    UniformName::new("niri_content_hdr", UniformType::_1f),
                    UniformName::new("niri_content_peak", UniformType::_1f),
